...
@synthesize UserID, Collaboratorname, Key, Avatarr, Emaill, Namee, Organizationn, Websitee;
...
- (void)fetchEntries
{
    ...
    NSString *urlString =[[NSString alloc] initWithFormat:@"http://coagmento.org/mobile/getUser.php?userID=%@", UserID];
